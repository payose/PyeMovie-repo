  ...
  <div class="home">
    <div class="feature-card">
      <router-link to="/movie/tt0409591">
        <img src="./naruto.jpg" alt="" class="featured-img">
        <div class="detail">
          <h3>Naruto</h3>
    ...
    <form @submit.prevent="SearchMovies()" class="search-box">
      <input type="text" placeholder="Search for your favourite movie..." v-model="search">
  ...
  .search-box{
    ...
    input{
      ...
      &[type="submit"] {
        width: 100%;
        max-width: 300px;
        background-color:rgba(17, 16, 15, 0.966);
        padding: 16px;
        border-radius: 8px;
        color: #fff;
        font-size: 20px;
